...
function initSearch() {
  ...
  request.open('GET', '/pr-154/92ed7c50ad49cd606c4b4ef2ab158451113186e2/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/pr-154/92ed7c50ad49cd606c4b4ef2ab158451113186e2/assets/css/just-the-docs-' + theme + '.css');
}
