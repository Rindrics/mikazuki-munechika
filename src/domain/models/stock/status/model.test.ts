...
describe("内部査読依頼", () => {
  ...
  it("内部査読依頼イベントを正しく生成する", () => {
    ...
    const { 内部査読依頼済み } = 内部査読依頼(作業中の資源評価, 日時, 認証済み主担当者, テスト用バージョン);
...
describe("受理取り消し", () => {
  const create内部査読受理済みの資源評価 = () => {
    ...
    const { 受理済み資源評価 } = 受理(内部査読中, new Date(), 認証済み資源評価管理者, テスト用バージョン);
    return 受理済み資源評価;
  };
  ...
  const create外部査読受理済みの資源評価 = () => {
    ...
    const { 受理済み資源評価 } = 受理(外部査読中, new Date(), 認証済み資源評価管理者, テスト用バージョン);
    return 受理済み資源評価;
  };
